        ...
        <div class="p-lg-5 p-4" >
            ...
            <div class="mt-4">
                <form class="auth-login-form mt-2" id="login_form">
                    ...
                    <div class="mt-4">
                        <button id="tombol_login" class="btn btn-success w-100" type="button" onclick="handle_login('#tombol_login','#login_form','{{route('auth.login')}}','POST');">Login</button>
                    </div>
                </form>
            </div>
        ...
        <div class="p-lg-5 p-4" >
            ...
            <div class="mt-4">
                <form class="auth-register-form mt-2" id="register_form">
                    ...
                    <div class="mt-4">
                        <button id="tombol_register" class="btn btn-success w-100" type="button" onclick="handle_post('#tombol_register','#register_form','{{route('auth.register')}}','POST');">Daftar</button>
                    </div>
                </form>
            </div>
